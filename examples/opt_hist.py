...
histValues = optHist.getValues(['xvars'], major='True')
print(histValues)

plt.plot("nMajor", "obj", data=histValues, label="Objective")
...
# axes[0].plot("nMajor", "obj", data=histValues, label="Objective")
# axes[0].set_ylabel("Objective \n(Fuel Burn)", rotation="horizontal", ha="right", fontsize=24)
...
plt.savefig(os.path.join(args.outputDir, "optview_test.png"))