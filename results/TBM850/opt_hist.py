...
print(histVals.keys())
# print(histVals)
# print(histVals['dv_comp.ac|geom|wing|taper'])

plt.figure(figsize=(8, 6))
plt.plot(histVals['ac|geom|wing|twist'][:,4], '-o')
plt.ylabel('DV: Wing Twist [deg]')
...
plt.savefig(os.path.join(args.outputDir, "TBM_fuel_roottwist.png"))